...
# Remplacement des valeurs manquantes par la valeur médiane de la colonen correspondante
clients = clients.fillna(clients.median())
clients_pred = clients_pred.fillna(clients_pred.median())
...
with st.expander("Plus d'informations"):
    ...
    titre = titre="Croisement des variables : "+var_1+" & "+var_2
    scat_plot = px.scatter(clients_pred, x= var_1, y=var_2, title=titre, color_continuous_scale='rdylgn_r', color ='SCORE' )
